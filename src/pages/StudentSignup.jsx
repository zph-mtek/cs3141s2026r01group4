    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if (signupData.password === matchPassword) {
                //check if email end with @mtu.edu
                if (signupData.email.endsWith('@mtu.edu') === true) {
                    ...
                    //alert and dont submit if the email does not end with @mtu.edu
                } else {
                    alert('Please use MTU email to register')
                }
            } else {
