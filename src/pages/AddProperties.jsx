          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="text" name="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 p-2 border" required placeholder='Husky Apartment' />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700">Distance from campus</label>
                <input type="text" name="distance-walk" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 p-2 border" required placeholder='0.5mile' />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700">Address</label>
                <input type="text" name="distance-walk" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 p-2 border" required placeholder='1801 Townsend Drive' />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700">Distance from campus on foot</label>
                <input type="text" name="distance-walk" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 p-2 border" required placeholder='15 minues walk' />
              </div>
            </div>
          </section>
        </form>
