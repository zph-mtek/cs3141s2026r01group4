...
const MainPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      {/* navbar */}
      <div className="flex w-full h-30 mb-30 justify-between">
        <img src={logoImage} className="w-45 h-45 ml-15" alt="" />

        <div className="flex mr-[3%] mt-10">
          <ul className="flex text-xl">
            <li className="mr-10">Find properties</li>
            <li className="mr-10">About</li>
            <li className="mr-10">Sign in</li>
          </ul>
        </div>
      </div>
